...
urlpatterns = [
    ...
    path('<uuid:customer_id>/add-payment/', views.CustomerPaymentView.as_view(), name='customer-add-payment'),
    path('<uuid:customer_id>/history/', views.CustomerHistoryView.as_view(), name='customer-history'),
